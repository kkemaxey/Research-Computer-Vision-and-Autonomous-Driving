# Setup Guide — Assembly, Data Pipeline & Self-Driving
 
> **Original author:** Omar Michael White-Evans (Computer Science, Class of 2026), advised by Prof. Abdelkrim Brania. Instructions verified by Kanayo Egwuekwe-Maxey (Computer Science, Class of 2027) prior to handoff. Last updated by Omar on July 27, 2026.
> This guide is preserved from the project handoff. Changes made by the current team are recorded in [`CHANGELOG.md`](../CHANGELOG.md).
 
End-to-end instructions for building a Waveshare UGV rover on an NVIDIA Jetson Orin Nano, collecting and annotating a training dataset, and training a YOLO model to drive the rover autonomously along a taped course.
